...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admin.posts.index'])->syncRoles([$role1,$role1]);
        Permission::create(['name' => 'admin.posts.create'])->syncRoles([$role1,$role1]);
        Permission::create(['name' => 'admin.posts.edit'])->syncRoles([$role1,$role1]);
        Permission::create(['name' => 'admin.posts.destroy'])->syncRoles([$role1,$role1]);
